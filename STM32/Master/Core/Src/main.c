...
/* USER CODE BEGIN PV */
 uint8_t receivedData_SensorOne[3];
 uint8_t receivedData_SensorTwo[3];

 uint8_t result;
 uint8_t result1;

 double airflow_sensorOne;
 double airflow_sensorTwo;

 uint16_t pressureSens1_kPa;
 uint16_t pressureSens2_kPa;
